    ...
    <div className="container-max py-8">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-5 whitespace-pre-line leading-relaxed text-neutral-600">
            {product.description || "Bu urun icin acikama yakinda eklenecek."}
          </p>
          ...
          <p className="mt-3 text-xs text-neutral-400">
            Bu bir affiliate baglantisidir. Bir Amazon Associate olarak uygun
            alisverislerden komisyon kazaniyoruz.
          </p>

          <div className="mt-8">
            <AdSlot slot={config.adsense.slotInline} label="Reklam (yan)" />
          </div>
        </div>
      </div>
      ...
      {related.length > 0 && (
        <section className="mt-14">
          <h2 className="mb-4 text-lg font-bold text-neutral-800">Bunlar da ilgini cekebilir</h2>
